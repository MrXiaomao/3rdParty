 ...
 */
AbstractSheet* Document::addSheet(const QString &name, AbstractSheet::SheetType type)
{
    Q_D(Document);
 ...
 */
AbstractSheet* Document::insertSheet(int index, const QString &name, AbstractSheet::SheetType type)
{
    Q_D(Document);
